...
if (isInside())
{
	...
	if ($db->nextRecord())
	{
		...
		$dParticipante_endereco_cep = utf8_encode($db->f("participante_cep"));
		...
		if ($dVersao == 1)
			$tApl = '
				...
				<div class="apl-row apl-br apl-bb apl-bl">
					...
					<div class="apl-lb w-130 bg-2">
						<a class="rbw'.(int)in_array($dRegistro_precos,array(1)).' cl-registro-precos-item"'.$check_readonly.' href="javascript:void(0);" style="left:14px;top:7px;">Sim</a>
						<a class="rbw'.(int)in_array($dRegistro_precos,array(2)).' cl-registro-precos-item"'.$check_readonly.' href="javascript:void(0);" style="left:70px;top:7px;">Não</a>
					</div>
				</div>
				...
				<div class="apl-row apl-br apl-bb apl-bl bg-3" style="height:76px;">
					<a class="rb'.(int)in_array($dModalidade_venda, array(1)).' cl-modalidade-venda-item"'.$check_readonly.' href="javascript:void(0);" style="left:40px;top:14px;">Compra Direta</a>
					<a class="rb'.(int)in_array($dModalidade_venda, array(2)).' cl-modalidade-venda-item"'.$check_readonly.' href="javascript:void(0);" style="left:250px;top:14px;">Tomada de Preços</a>
					<a class="rb'.(int)in_array($dModalidade_venda, array(3)).' cl-modalidade-venda-item"'.$check_readonly.' href="javascript:void(0);" style="left:460px;top:14px;">Pregão Presencial</a>
					<a class="rb'.(int)in_array($dModalidade_venda, array(4)).' cl-modalidade-venda-item"'.$check_readonly.' href="javascript:void(0);" style="left:670px;top:14px;">Adesão a Registro de Preços</a>
					<a class="rb'.(int)in_array($dModalidade_venda, array(5)).' cl-modalidade-venda-item"'.$check_readonly.' href="javascript:void(0);" style="left:40px;bottom:13px;">Carta Convite</a>
					<a class="rb'.(int)in_array($dModalidade_venda, array(6)).' cl-modalidade-venda-item"'.$check_readonly.' href="javascript:void(0);" style="left:250px;bottom:13px;">Concorrência</a>
					<a class="rb'.(int)in_array($dModalidade_venda, array(7)).' cl-modalidade-venda-item"'.$check_readonly.' href="javascript:void(0);" style="left:460px;bottom:13px;">Pregão Eletrônico</a>
					<a class="rb'.(int)in_array($dModalidade_venda, array(8)).' cl-modalidade-venda-item"'.$check_readonly.' href="javascript:void(0);" style="left:670px;bottom:13px;">Aditivo Contratual</a>
				</div>
				<div class="apl-row apl-br apl-bb apl-bl">
				...
				<div class="apl-row apl-br apl-bb apl-bl bg-3" style="height:165px;">
					<a class="cb'.(int)in_array(1, $dV1_documentacao_selecionados).'"'.$check_readonly.' href="javascript:void(0);" style="left:40px;top:14px;">Atestado de Capacidade Técnica</a>
					<a class="cb'.(int)in_array(2, $dV1_documentacao_selecionados).'"'.$check_readonly.' href="javascript:void(0);" style="left:40px;top:34px;">Ato Constitutivo</a>
					<a class="cb'.(int)in_array(3, $dV1_documentacao_selecionados).'"'.$check_readonly.' href="javascript:void(0);" style="left:40px;top:54px;">Balanço Patrimonial</a>
					<a class="cb'.(int)in_array(4, $dV1_documentacao_selecionados).'"'.$check_readonly.' href="javascript:void(0);" style="left:40px;top:74px;">Certidão de Tributos Estaduais</a>
					<a class="cb'.(int)in_array(5, $dV1_documentacao_selecionados).'"'.$check_readonly.' href="javascript:void(0);" style="left:40px;top:94px;">Certidão de Tributos Federais / Divida Ativa da União (Internet)</a>
					<a class="cb'.(int)in_array(6, $dV1_documentacao_selecionados).'"'.$check_readonly.' href="javascript:void(0);" style="left:40px;top:114px;">Certidão de Tributos Municipais</a>
					<a class="cb'.(int)in_array(7, $dV1_documentacao_selecionados).'"'.$check_readonly.' href="javascript:void(0);" style="left:40px;top:134px;">CND INSS (Internet)</a>
					<a class="cb'.(int)in_array(8, $dV1_documentacao_selecionados).'"'.$check_readonly.' href="javascript:void(0);" style="left:490px;top:14px;">CNDT - Certidão Negativa de Débitos Trabalhistas (Internet)</a>
					<a class="cb'.(int)in_array(9, $dV1_documentacao_selecionados).'"'.$check_readonly.' href="javascript:void(0);" style="left:490px;top:34px;">CNPJ (Internet)</a>
					<a class="cb'.(int)in_array(10, $dV1_documentacao_selecionados).'"'.$check_readonly.' href="javascript:void(0);" style="left:490px;top:54px;">Falência e Concordata</a>
					<a class="cb'.(int)in_array(11, $dV1_documentacao_selecionados).'"'.$check_readonly.' href="javascript:void(0);" style="left:490px;top:74px;">FGTS (Internet)</a>
					<a class="cb'.(int)in_array(12, $dV1_documentacao_selecionados).'"'.$check_readonly.' href="javascript:void(0);" style="left:490px;top:94px;">Ficha de Inscrição Estadual)</a>
					<a class="cb'.(int)in_array(13, $dV1_documentacao_selecionados).'"'.$check_readonly.' href="javascript:void(0);" style="left:490px;top:114px;">Ficha de Inscrição Municipal</a>
					<a class="cb'.(int)in_array(14, $dV1_documentacao_selecionados).'"'.$check_readonly.' href="javascript:void(0);" style="left:490px;top:134px;">Procuração</a>
				</div>
				...
				<div class="apl-row apl-br apl-bb apl-bl">
					...
					<div class="apl-lb w-130 bg-2">
						<a class="rbw'.(int)in_array($dTransformacao, array(1)).' cl-transformacao-item"'.$check_readonly.' href="javascript:void(0);" style="left:14px;top:7px;">Sim</a>
						<a class="rbw'.(int)in_array($dTransformacao, array(2)).' cl-transformacao-item"'.$check_readonly.' href="javascript:void(0);" style="left:70px;top:7px;">Não</a>
					</div>
				</div>
				<div class="apl-row apl-br apl-bb apl-bl">
				...
				<div class="apl-row apl-br apl-bb apl-bl">
					...
					<div class="apl-lb w-636 bg-3">
						<a class="rb'.(int)in_array($dGarantia, array(1)).' cl-garantia-item"'.$check_readonly.' href="javascript:void(0);" style="left:40px;top:7px;">Garantia Padrão</a>
						<a class="rb'.(int)in_array($dGarantia, array(2)).' cl-garantia-item"'.$check_readonly.' href="javascript:void(0);" style="left:300px;top:7px;">Garantia Diferenciada</a>
					</div>
				</div>
				<div class="apl-row apl-br apl-bb apl-bl">
				...
				<div class="apl-row apl-br apl-bb apl-bl bg-3" style="height:41px;">
					<a class="rb'.(int)in_array($dOrigem_verba, array(1)).' cl-origem-verba-item"'.$check_readonly.' href="javascript:void(0);" style="left:40px;top:12px;">Federal</a>
					<a class="rb'.(int)in_array($dOrigem_verba, array(2)).' cl-origem-verba-item"'.$check_readonly.' href="javascript:void(0);" style="left:250px;top:12px;">Estadual</a>
					<a class="rb'.(int)in_array($dOrigem_verba, array(3)).' cl-origem-verba-item"'.$check_readonly.' href="javascript:void(0);" style="left:460px;top:12px;">Municipal</a>
					<a class="rb'.(int)in_array($dOrigem_verba, array(4)).' cl-origem-verba-item"'.$check_readonly.' href="javascript:void(0);" style="left:670px;top:12px;">Convenio</a>
				</div>
				<div class="apl-row apl-br apl-bb apl-bl">
				...
				<div class="apl-row apl-br apl-bb apl-bl bg-3" style="height:106px;">
					<a class="rb'.(int)in_array($dIsencao_impostos, array(1)).' cl-isensao-impostos-item"'.$check_readonly.' href="javascript:void(0);" style="left:40px;top:14px;">Não possui isenção</a>
					<a class="rb'.(int)in_array($dIsencao_impostos, array(2)).' cl-isensao-impostos-item"'.$check_readonly.' href="javascript:void(0);" style="left:250px;top:14px;">IPI</a>
					<a class="rb'.(int)in_array($dIsencao_impostos, array(3)).' cl-isensao-impostos-item"'.$check_readonly.' href="javascript:void(0);" style="left:460px;top:14px;">ICMS Substituto</a>
					<a class="rb'.(int)in_array($dIsencao_impostos, array(4)).' cl-isensao-impostos-item"'.$check_readonly.' href="javascript:void(0);" style="left:40px;bottom:43px;">IPI + ICMS</a>
					<a class="rb'.(int)in_array($dIsencao_impostos, array(5)).' cl-isensao-impostos-item"'.$check_readonly.' href="javascript:void(0);" style="left:250px;bottom:43px;">ICMS</a>
					<a class="rb'.(int)in_array($dIsencao_impostos, array(6)).' cl-isensao-impostos-item"'.$check_readonly.' href="javascript:void(0);" style="left:460px;bottom:43px;">IPI + ICMS Substituto</a>
			...
			$tApl = '
				...
				<div class="apl-row apl-br apl-bb apl-bl">
					...
					<div class="apl-lb w-130 bg-2">
						<a id="drop-estado-1" class="estado-drop drp"'.$check_readonly.' href="javascript:void(0);" style="width:130px;padding-left:14px;"><span>'.$dEstado.'</span><img src="img/a-down-w.png"></a>
					</div>
				</div>
				<div id="hook-modalidade-venda" class="apl-row apl-br apl-bb apl-bl" style="height:6px;"></div>
				<div class="apl-row apl-br apl-bb apl-bl">
				...
				<div class="apl-row apl-br apl-bb apl-bl">
					...
					<div class="apl-lb w-130 bg-2">
						<a class="rbw'.(int)in_array($dEficiencia_energetica, array(1)).' cl-eficiencia-energetica-item"'.$check_readonly.' href="javascript:void(0);" style="left:14px;top:7px;">Sim</a>
						<a class="rbw'.(int)in_array($dEficiencia_energetica, array(2)).' cl-eficiencia-energetica-item"'.$check_readonly.' href="javascript:void(0);" style="left:70px;top:7px;">Não</a>
					</div>
				</div>
				<div class="apl-row apl-br apl-bb apl-bl">
				...
				<div class="apl-row apl-br apl-bb apl-bl">
					...
					<div class="apl-lb w-130 bg-2">
						<a class="rbw'.(int)in_array($dTransformacao_prototipo, array(1)).' cl-transformacao-prototipo-item"'.$check_readonly.' href="javascript:void(0);" style="left: 14px; top: 7px;">Sim</a>
						<a class="rbw'.(int)in_array($dTransformacao_prototipo, array(2)).' cl-transformacao-prototipo-item"'.$check_readonly.' href="javascript:void(0);" style="left: 70px; top: 7px;">Não</a>
					</div>
				</div>
				...
				<div class="apl-row apl-br apl-bb apl-bl bg-1 center white">
					<div style="display:inline-block;overflow:hidden;">
						<span id="hook-acessorios" class="apl-lb">Acessórios e Emplacamento/Licenciamento/IPVA (Custo pago pelo Concessionário)</span>
						<a class="rbw'.(int)in_array($dAcessorios, array(1)).' cl-acessorios-item"'.$check_readonly.' href="javascript:void(0);" style="position:relative;float:left;margin:8px 0 0 40px;">Sim</a>
						<a class="rbw'.(int)in_array($dAcessorios, array(2)).' cl-acessorios-item"'.$check_readonly.' href="javascript:void(0);" style="position:relative;float:left;margin:8px 0 0 14px;">Não</a>
					</div>
				</div>
				...
				<div class="apl-row apl-br apl-bb apl-bl">
					...
					<div class="apl-lb bg-2" style="width:130px;">
						<a class="rbw'.(int)in_array($dEmplacamento, array(1)).' cl-emplacamento-item"'.$check_readonly.' href="javascript:void(0);" style="left:14px;top:7px;">Sim</a>
						<a class="rbw'.(int)in_array($dEmplacamento, array(2)).' cl-emplacamento-item"'.$check_readonly.' href="javascript:void(0);" style="left:70px;top:7px;">Não</a>
					</div>
					<span class="apl-lb bg-3 center" style="width:182px;">Licenciamento</span>
					<div class="apl-lb bg-2" style="width:130px;">
						<a class="rbw'.(int)in_array($dLicenciamento, array(1)).' cl-licenciamento-item"'.$check_readonly.' href="javascript:void(0);" style="left:14px;top:7px;">Sim</a>
						<a class="rbw'.(int)in_array($dLicenciamento, array(2)).' cl-licenciamento-item"'.$check_readonly.' href="javascript:void(0);" style="left:70px;top:7px;">Não</a>
					</div>
					<span class="apl-lb bg-3 center" style="width:182px;">IPVA</span>
					<div class="apl-lb bg-2" style="width:130px;">
						<a class="rbw'.(int)in_array($dIpva, array(1)).' cl-ipva-item"'.$check_readonly.' href="javascript:void(0);" style="left:14px;top:7px;">Sim</a>
						<a class="rbw'.(int)in_array($dIpva, array(2)).' cl-ipva-item"'.$check_readonly.' href="javascript:void(0);" style="left:70px;top:7px;">Não</a>
					</div>
				</div>
				<div class="apl-row apl-br apl-bb apl-bl">
				...
				<div class="apl-row apl-br apl-bb apl-bl">
					...
					<div class="apl-lb w-636 bg-2">
						<a class="rbw'.(int)in_array($dGarantia, array(1)).' cl-garantia-item"'.$check_readonly.' href="javascript:void(0);" style="position:relative;float:left;margin-left:40px;margin-top:7px;">Garantia Padrão</a>
						<a class="rbw'.(int)in_array($dGarantia, array(2)).' cl-garantia-item"'.$check_readonly.' href="javascript:void(0);" style="position:relative;float:left;margin-left:40px;margin-top:7px;">Garantia Diferenciada</a>
					</div>
				</div>
				<div class="apl-row apl-br apl-bb apl-bl">
					...
					<div class="apl-lb bg-2" style="width:130px;">
						<a class="rbw'.(int)in_array($dRevisao_embarcada, array(1)).' cl-revisao-embarcada-item"'.$check_readonly.' href="javascript:void(0);" style="left:14px;top:7px;">Sim</a>
						<a class="rbw'.(int)in_array($dRevisao_embarcada, array(2)).' cl-revisao-embarcada-item"'.$check_readonly.' href="javascript:void(0);" style="left:70px;top:7px;">Não</a>
					</div>
				</div>
				<div class="apl-row apl-br apl-bb apl-bl">
					...
					<div class="apl-lb bg-2" style="width:150px;">
						<a class="rbw'.(int)in_array($dLimite_km, array(1)).' cl-limite-km-item"'.$check_readonly.' href="javascript:void(0);" style="left: 14px; top: 7px;">Sim</a>
						<a class="rbw'.(int)in_array($dLimite_km, array(2)).' cl-limite-km-item"'.$check_readonly.' href="javascript:void(0);" style="left: 70px; top: 7px;">Não</a>
					</div>
				...
				<div class="apl-row apl-br apl-bb apl-bl">
					...
					<div class="apl-lb bg-2" style="width:148px;">
						<a id="drop-estado-2" class="estado-drop drp"'.$check_readonly.' href="javascript:void(0);" style="width:148px;padding-left:14px;"><span>'.$dDn_venda_estado.'</span><img src="img/a-down-w.png"></a>
					</div>
				...
				<div class="apl-row apl-br apl-bb apl-bl">
					...
					<div class="apl-lb bg-2" style="width:148px;">
						<a id="drop-estado-3" class="estado-drop drp"'.$check_readonly.' href="javascript:void(0);" style="width:148px;padding-left:14px;"><span>'.$dDn_entrega_estado.'</span><img src="img/a-down-w.png"></a>
					</div>
				...
				<div class="apl-row apl-br apl-bb apl-bl">
					...
					<span class="apl-lb bg-3 center" style="width:280px;">Multas e Sansões – Indicar ítem do Edital</span>
				...
				<div class="apl-row apl-br apl-bb apl-bl">
					...
					<div class="apl-lb bg-2" style="width:266px;">
						<a class="rbw'.(int)in_array($dGarantia_contrato, array(1)).' cl-garantia-contrato-item"'.$check_readonly.' href="javascript:void(0);" style="left:14px;top:7px;">Sim</a>
						<a class="rbw'.(int)in_array($dGarantia_contrato, array(2)).' cl-garantia-contrato-item"'.$check_readonly.' href="javascript:void(0);" style="left:70px;top:7px;">Não</a>
					</div>
				...
				<div class="apl-row apl-br apl-bb apl-bl bg-2" style="height:41px;">
					<a class="rbw'.(int)in_array($dOrigem_verba_tipo, array(1)).' cl-origem-verba-tipo-item"'.$check_readonly.' href="javascript:void(0);" style="left: 40px; top: 12px;">A Vista</a>
					<a class="rbw'.(int)in_array($dOrigem_verba_tipo, array(2)).' cl-origem-verba-tipo-item"'.$check_readonly.' href="javascript:void(0);" style="left: 250px; top: 12px;">A Prazo</a>
				</div>
				<div class="apl-row apl-br apl-bb apl-bl">
					<span id="hook-isencao-impostos" class="apl-lb w-936 bg-1 white center">Isenções de Impostos do Órgão</span>
				</div>
				<div class="apl-row apl-br apl-bl bg-3" style="height:80px;">
					...
					<a class="rb'.(int)in_array($dIsencao_impostos, array(2)).' cl-isensao-impostos-item"'.$check_readonly.' href="javascript:void(0);" style="left:250px;top:14px;">IPI</a>
					<a class="rb'.(int)in_array($dIsencao_impostos, array(3)).' cl-isensao-impostos-item"'.$check_readonly.' href="javascript:void(0);" style="left:460px;top:14px;">ICMS Substituto</a>
					<a class="rb'.(int)in_array($dIsencao_impostos, array(4)).' cl-isensao-impostos-item"'.$check_readonly.' href="javascript:void(0);" style="left:40px;top:46px;">IPI + ICMS</a>
					<a class="rb'.(int)in_array($dIsencao_impostos, array(5)).' cl-isensao-impostos-item"'.$check_readonly.' href="javascript:void(0);" style="left:250px;top:46px;">ICMS</a>
					<a class="rb'.(int)in_array($dIsencao_impostos, array(6)).' cl-isensao-impostos-item"'.$check_readonly.' href="javascript:void(0);" style="left:460px;top:46px;">IPI + ICMS Substituto</a>
				</div>
				<div class="apl-row apl-br apl-bb apl-bl bg-3">
...
WHERE
	...
	his.id_cliente = cli.id");
		if ($db->nextRecord())
		{
			...
			$tApl .= '<div class="apl-row bg-3 apl-bl apl-br" style="text-align: left; font-size: 11px; padding: 0 40px;">APL preenchida e enviada em <span class="bold">'.mysqlToBr(substr($db->f("data_hora"),0,10)).'</span> às <span class="bold gray-88">'.substr($db->f("data_hora"),11).'</span> por <span class="bold italic">'.$por.'</span> de <span class="red">'.$db->f("ip").'</span></span></div>';
		}
...
LIMIT 1");
		if ($db->nextRecord())
			$historico_btn = '<br><br><a class="bt-style-2 fr" href="javascript:void(0);" onclick="licAPL_historico('.$pId_item.','.$dId_parent.');">Histórico de Aprovações/Reprovações</a>';



		if ($dTipo == 2)
			$tApl .= '<div class="apl-row t13 bg-3 apl-bl apl-br" style="padding: 20px 40px; text-align: left; line-height: normal;"><span class="bold green t20">Aprovada!</span>'.$info.$historico_btn.'</div>';
		else if ($dTipo == 4)
			$tApl .= '<div class="apl-row t13 bg-3 apl-bl apl-br" style="padding: 20px 40px; text-align: left; line-height: normal;"><span class="bold red t20" style="font-size:20px;">Reprovada.</span>'.$info.$historico_btn.'</div>';

		$aReturn[1] = '<div style="width:938px; margin: 0 auto;"><div style="height:8px;"><!-- --></div>'.$tApl.'<div class="apl-bt" style="height:20px;"><!-- --></div></div>';
	}
	else
	{
