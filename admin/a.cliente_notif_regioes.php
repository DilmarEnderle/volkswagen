...
if (isInside())
{
	...
	$oOutput = '<div class="ultimate-row" style="font-weight:bold;line-height:40px;">'.$pCat.' &gt; '.$pMsg.' &gt; '.$aTipo[$pTipo].'</div>
		...
		<div class="ultimate-row" style="margin-top: 20px;">
			<a id="ck-global" class="check-chk0" href="javascript:void(0);" onclick="ckONLY(this);" style="position: relative; float: left; font-size: 13px;">Aplicar global <span class="red">(alterar todas as outros notificações com estas regiões)</span></a>
		</div>';
