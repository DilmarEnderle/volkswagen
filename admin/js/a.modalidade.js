...
function removerModalidade(id, now)
{
	if (ajax)
	{
		if (now)
		...
		else
		{
			ultimateDialog({
				title:'Remover ?',
				color:'red',
				content:'Esta modalidade será removida do sistema.<br><br><span class="bold">Você tem certeza que deseja continuar?</span>',
				buttons:{'Sim':{onclick:'removerModalidade('+id+',true);ultimateClose();',is_default:1,css_class:'ultimate-btn-red ultimate-btn-left ultimate-btn-60'},'Cancelar':{css_class:'ultimate-btn-gray ultimate-btn-right'}}
			});
		}
	}
}
