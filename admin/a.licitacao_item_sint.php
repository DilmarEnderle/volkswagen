...
if (isInside())
{
	...
	$oHtml = '<div class="ultimate-row" style="max-height:280px;overflow-x:hidden;overflow-y:auto;">
		<div class="ultimate-row">Selecione o motivo de declínio:</div>
		<select id="i-sint-motivo" style="height:30px;width:100%;">
...
FROM
    ...
    LEFT JOIN gelic_licitacoes_itens_check AS icheck ON icheck.sem_interesse_dn_id_motivo = mtv.id AND id_item = $pId_item
WHERE
	mtv.tipo = 22
ORDER BY
	mtv.descricao");
