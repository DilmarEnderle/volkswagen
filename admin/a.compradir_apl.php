...
'.$valor_transf.$anexo.'
				...
				$info .= '<div class="apl-row" style="text-align: left; font-size: 11px;">APL aprovada em <span class="bold">'.mysqlToBr(substr($db->f("data_hora"),0,10)).'</span> às <span class="bold gray-88">'.substr($db->f("data_hora"),11).'</span> por <span class="bold italic">'.utf8_encode($db->f("nome")).'</span> de <span class="red">'.$db->f("ip").'</span></span>'.$apr_tbl.'</div>';
			}
			else if ($tipo == 4)
				$info .= '<div class="apl-row" style="text-align: left; font-size: 11px;">APL reprovada em <span class="bold">'.mysqlToBr(substr($db->f("data_hora"),0,10)).'</span> às <span class="bold gray-88">'.substr($db->f("data_hora"),11).'</span> por <span class="bold italic">'.utf8_encode($db->f("nome")).'</span> de <span class="red">'.$db->f("ip").'</span></span></div>';
		...
		if ($tipo == 2)
			$tApl .= '<div class="apl-row t13" style="padding: 20px 40px; border: 1px solid #cecece; border-top: none; text-align: left; line-height: normal;"><span class="bold green t20" style="font-size:20px;">Aprovada!</span>'.$info.'</div></div>';
		else if ($tipo == 4)
			$tApl .= '<div class="apl-row t13" style="padding: 20px 40px; border: 1px solid #cecece; border-top: none; text-align: left; line-height: normal;"><span class="bold red t20" style="font-size:20px;">Reprovada.</span>'.$info.'</div></div>';
