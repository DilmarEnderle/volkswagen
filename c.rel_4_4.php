...
GROUP BY
	lic.id");
		...
		if (file_exists(UPLOAD_DIR."~bo_rel_4_4_".$sInside_id.".xlsx"))
			unlink(UPLOAD_DIR."~bo_rel_4_4_".$sInside_id.".xlsx");

		$obwriter = PHPExcel_IOFactory::createWriter($phpexcel, 'Excel2007');
		$obwriter->save(UPLOAD_DIR."~bo_rel_4_4_".$sInside_id.".xlsx");
