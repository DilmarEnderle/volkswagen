...
//{
	...
	if (file_exists(UPLOAD_DIR."/~upload_apl_spacefox_".$sInside_id.".tmp"))
		unlink(UPLOAD_DIR."/~upload_apl_spacefox_".$sInside_id.".tmp");

	if (move_uploaded_file($_FILES["f-upload"]["tmp_name"], UPLOAD_DIR."/~upload_apl_spacefox_".$sInside_id.".tmp"))
	{
