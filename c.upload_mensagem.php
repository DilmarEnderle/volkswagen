...
$aReturn = array("status">=0, "long_filename"=>"", "short_filename"=>"", "file_size"=>"");
if (isInside())
{
	...
	if (file_exists(UPLOAD_DIR."~upmsgc_".$sInside_id.".tmp"))
		unlink(UPLOAD_DIR."~upmsgc_".$sInside_id.".tmp");

	if (move_uploaded_file($_FILES["f-upload"]["tmp_name"], UPLOAD_DIR."~upmsgc_".$sInside_id.".tmp"))
	{
